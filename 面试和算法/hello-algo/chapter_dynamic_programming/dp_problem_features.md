...
![爬到第 3 阶的最小代价](https://gitee.com/taoweitao/hello-algo/raw/dev/docs/chapter_dynamic_programming/dp_problem_features.assets/min_cost_cs_example.png)
...
![爬楼梯最小代价的动态规划过程](https://gitee.com/taoweitao/hello-algo/raw/dev/docs/chapter_dynamic_programming/dp_problem_features.assets/min_cost_cs_dp.png)
...
![带约束爬到第 3 阶的方案数量](https://gitee.com/taoweitao/hello-algo/raw/dev/docs/chapter_dynamic_programming/dp_problem_features.assets/climbing_stairs_constraint_example.png)
...
![考虑约束下的递推关系](https://gitee.com/taoweitao/hello-algo/raw/dev/docs/chapter_dynamic_programming/dp_problem_features.assets/climbing_stairs_constraint_state_transfer.png)
