...
- 解决：已经将`get_byte`的内容合并到`get`中，并且删除了`get_byte`的方法
  ...
  <img src="https://cdn.davidingplus.cn/images/2025/02/01/image-20231102161644258.png" alt="image-20231102161644258" style="zoom:67%;" />

  <img src="https://cdn.davidingplus.cn/images/2025/02/01/image-20231102161658180.png" alt="image-20231102161658180" style="zoom: 50%;" />
...
- 解决：先看我自己的写的一个程序来请求一张图片
  ...
  ![image-20231102161917371](https://cdn.davidingplus.cn/images/2025/02/01/image-20231102161917371.png)
  ...
  ![image-20231102162008638](https://cdn.davidingplus.cn/images/2025/02/01/image-20231102162008638.png)

  现在再来看`HttpControlTest`的`testGetPic()`的结果，我在`get`请求中做了一次打印`readMessage`的操作：

  <img src="https://cdn.davidingplus.cn/images/2025/02/01/image-20231102162217145.png" alt="image-20231102162217145" style="zoom:67%;" />

  结果如下：

  请求成功了，我们先不管响应数据怎么样，就像昨天说的，这是`LString`那边报的错，所以理应来说这个`get`发送的请求是没问题的

  ![image-20231102162244939](https://cdn.davidingplus.cn/images/2025/02/01/image-20231102162244939.png)
