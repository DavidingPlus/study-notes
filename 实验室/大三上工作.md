...
~~~bash
# A_1_5_1 R_1_6_18 R_1_6_12 R_1_5_2 R_1_6_5 R_1_7_8
...
# 首先需要把我自己的代码拷贝出去
cd /home/lzx0626/DavidingPlus/Lark5/llvm-project/clang-tools-extra/clang-tidy/gjb8114

# 后续自己添加
cp A_1_5_1* /home/lzx0626/DavidingPlus/Lark5/llvm-project
cp R_1_6_18* /home/lzx0626/DavidingPlus/Lark5/llvm-project
cp R_1_6_12* /home/lzx0626/DavidingPlus/Lark5/llvm-project
cp R_1_5_2* /home/lzx0626/DavidingPlus/Lark5/llvm-project
cp R_1_6_5* /home/lzx0626/DavidingPlus/Lark5/llvm-project
cp R_1_7_8* /home/lzx0626/DavidingPlus/Lark5/llvm-project

# 拷贝git拉取的代码修改的部分到llvm目录
cp /home/lzx0626/DavidingPlus/Lark5/larkscanner/clang-tidy/src/gjb8114/* . -r

# 移动回去
cd /home/lzx0626/DavidingPlus/Lark5/llvm-project/
mv *.cpp *.h /home/lzx0626/DavidingPlus/Lark5/llvm-project/clang-tools-extra/clang-tidy/gjb8114
~~~
...
R_1_6_12：测试提的bug存在问题，已经解决
R_1_5_2：自测完成(已上传，等待反馈)
R_1_6_5：自测完成(已上传，等待反馈)
R_1_7_8：自测完成(已上传，等待反馈)
R_1_6_18：gets函数被c++废弃了，检测会报出未定义，没办法用我自己的规则(问了这个要想办法解决，所以还要继续)
~~~
...
~~~bash
conan install ..
cmake -DCMAKE_C_COMPILER=/usr/bin/gcc-9 -DCMAKE_CXX_COMPILER=/usr/bin/g++-9 -DENABLE_DOXYGEN=OFF ..
...
~~~bash
cmake -DCMAKE_C_COMPILER=/usr/bin/gcc-9 -DCMAKE_CXX_COMPILER=/usr/bin/g++-9 -DENABLE_DOXYGEN=OFF -DENABLE_GTEST=ON ..
...
# 生成单页 html 覆盖率简报
gcovr --exclude-throw-branches --exclude-unreachable-branches --html build/gcovr.html

# 生成多页面 html 详细覆盖率报告到 gcovr 目录中
mkdir build/gcovr
gcovr --exclude-throw-branches --exclude-unreachable-branches --html-details build/gcovr/gcovr.html
