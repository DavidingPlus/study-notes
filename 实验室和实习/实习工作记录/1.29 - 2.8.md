...
- 单例与多态结合
  ...
  - 在构造`Application`的时候，构造单例平台相关接口
...
- `LApplication`和`lplatforminterface`的移动构造和移动赋值函数的参数应该不需要带上`const`
  ...
  <img src="https://img-blog.csdnimg.cn/direct/dfaad54b9e4a45af9578faf4ab2ffd33.png" alt="image-20240131142031853" style="zoom:75%;" />

  <img src="https://img-blog.csdnimg.cn/direct/ec38729233b643e898eba10708153b20.png" alt="image-20240131141725174" style="zoom:75%;" />
