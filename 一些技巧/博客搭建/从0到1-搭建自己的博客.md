...
这是我的博客，我使用的是国内`Gitee Pages`服务，因为在国内会快一点 。

链接：[https://davidingplus.gitee.io](https://davidingplus.gitee.io)

![image-20230929110322139](https://img-blog.csdnimg.cn/direct/b09e25edced146ccb6fdf373b48b1741.png)
...
- 例如，我就在我自己的服务器上部署了一个：[http://106.55.60.140](http://106.55.60.140)

当然，抠门的我们肯定想白嫖啊，因此`Git Pages`服务就是不二的选择

我使用的就是`Gitee Pages`服务，因为在国内访问的比较快，写这篇文章的时候我还没有购买域名，也就没有办法把`GitHub`上面的做`CDN`加速，所以还是用`Gitee Pages`服务好一点
...
具体可以参考我的仓库配置，链接：[https://gitee.com/DavidingPlus/DavidingPlus](https://gitee.com/DavidingPlus/DavidingPlus)

# 总结

通过以上，去搭建你自己的博客吧，当然如果是全栈大佬请当乐子看，你们有更好的方式
